import "./chunk-F24DXLHQ.js";
import {
  ConstantsUtil,
  getTransport
} from "./chunk-H5MIQWCG.js";
import "./chunk-T4OHZ77L.js";
import "./chunk-GJBZJ4UL.js";
import {
  W3mFrameProvider
} from "./chunk-UUILACVG.js";
import "./chunk-PVWKNNEO.js";
import "./chunk-RXH5RMS6.js";
import "./chunk-WJP646FZ.js";
import "./chunk-6I7O664T.js";
import "./chunk-CNB5PB42.js";
import "./chunk-U6O6RVJR.js";
import "./chunk-XB24JCTF.js";
import {
  createConfig,
  createConnector,
  injected
} from "./chunk-6YIKXO4R.js";
...
import {
  ...
  withRetry,
  withTimeout
} from "./chunk-P7EIXP2T.js";
import "./chunk-Z4BR42XQ.js";
import "./chunk-MB5DXHTX.js";
import "./chunk-EWAXOTDC.js";
import {
  ResourceUnavailableRpcError,
  SwitchChainError,
  UserRejectedRequestError
} from "./chunk-ECXEZH5W.js";
import {
  getAddress,
  numberToHex
} from "./chunk-UZY4L5LW.js";
import "./chunk-TEQAYQEZ.js";
import "./chunk-ZMBOH3S2.js";
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-LBWNF72D.js");
...
function version3(parameters) {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-2IJTOGA4.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-5P7J5UXJ.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SafeAppsSDK } = await import("./src-LKJE6AAU.js");
        let SDK;
        ...
        const { SafeAppProvider } = await import("./dist-JMNH4NHD.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-XQHYVSAG.js");
