  ...
  async initOrContinue() {
    if (!this.initPromise && !isInitialized && CoreHelperUtil.isClient()) {
      ...
      this.initPromise = new Promise(async (resolve) => {
        await Promise.all([import("./esm-ZZGBKTMX.js"), import("./w3m-modal-FZG4FL4H.js")]);
...
var W3mAccountWalletFeaturesWidget = class W3mAccountWalletFeaturesWidget2 extends LitElement {
  ...
  onSwapClick() {
    var _a2, _b2;
    if (((_a2 = this.network) == null ? void 0 : _a2.id) && !ConstantsUtil.SWAP_SUPPORTED_NETWORKS.includes((_b2 = this.network) == null ? void 0 : _b2.id)) {
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-H5MIQWCG.js.map
