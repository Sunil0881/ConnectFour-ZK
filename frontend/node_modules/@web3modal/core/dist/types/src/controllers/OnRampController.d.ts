import type { PurchaseCurrency, PaymentCurrency } from '@web3modal/core/dist/types/src/utils/TypeUtil.js';
...
export declare const OnRampController: {
    ...
    getQuote(): Promise<import("@web3modal/core/dist/types/src/utils/TypeUtil.js").OnrampQuote | null>;
    resetState(): void;
};
