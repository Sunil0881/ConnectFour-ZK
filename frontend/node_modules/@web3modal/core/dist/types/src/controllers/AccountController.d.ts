import type { CaipAddress, ConnectedWalletInfo, SocialProvider } from '@web3modal/core/dist/types/src/utils/TypeUtil.js';
...
export declare const AccountController: {
    ...
    setSocialWindow(socialWindow: AccountControllerState['socialWindow']): void;
