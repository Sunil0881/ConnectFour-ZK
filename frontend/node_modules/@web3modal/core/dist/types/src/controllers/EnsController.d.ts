...
export declare const EnsController: {
    ...
    resolveName(name: string): Promise<import("@web3modal/core/dist/types/src/utils/TypeUtil.js").BlockchainApiLookupEnsName>;
    isNameRegistered(name: string): Promise<boolean>;
    getSuggestions(name: string): Promise<Suggestion[]>;
    getNamesForAddress(address: string): Promise<import("@web3modal/core/dist/types/src/utils/TypeUtil.js").BlockchainApiLookupEnsName[]>;
    registerName(name: string): Promise<void>;
    validateName(name: string): boolean;
    parseEnsApiError(error: unknown, defaultError: string): string;
    isAllowedToRegisterName(): boolean | "" | undefined;
};
export {};
