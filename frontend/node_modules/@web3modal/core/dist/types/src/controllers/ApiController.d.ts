import { FetchUtil } from '@web3modal/core/dist/types/src/utils/FetchUtil.js';
import type { ApiGetWalletsRequest, WcWallet } from '@web3modal/core/dist/types/src/utils/TypeUtil.js';
...
export declare const ApiController: {
    ...
    _getApiHeaders(): {
        'x-project-id': string;
        'x-sdk-type': "w3m";
        'x-sdk-version': import("@web3modal/core/dist/types/src/utils/TypeUtil.js").SdkVersion;
    };
